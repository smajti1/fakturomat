<div class="mb-3{{ $errors->has('company_email') ? ' has-danger' : '' }}">
    ...
    <input id="company_email" type="text" class="form-control form-control-danger" name="company_email"
           value="{{ old('company_email') }}" placeholder="E-mail firmowy">
...
<div class="mb-3{{ $errors->has('website') ? ' has-danger' : '' }}">
    ...
    <input id="website" type="text" class="form-control form-control-danger" name="website" value="{{ old('website') }}"
...
<div class="mb-3{{ $errors->has('phone') ? ' has-danger' : '' }}">
    ...
    <input id="phone" type="text" class="form-control form-control-danger" name="phone" value="{{ old('phone') }}"
           placeholder="Telefon">
