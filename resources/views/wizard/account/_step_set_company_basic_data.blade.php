<div class="mb-3{{ $errors->has('company_name') ? ' has-danger' : '' }}">
    ...
    <input id="company_name" type="text" class="form-control form-control-danger" placeholder="Nazwa firmy"
           name="company_name" value="{{ old('company_name', $wizardData['company_name'] ?? '') }}" required autofocus>
...
<div class="mb-3{{ $errors->has('tax_id_number') ? ' has-danger' : '' }}">
    ...
    <input id="tax_id_number" type="text" class="form-control form-control-danger" name="tax_id_number"
           value="{{ old('tax_id_number', $wizardData['tax_id_number'] ?? '') }}" placeholder="Nip">
...
<div class="mb-3{{ $errors->has('regon') ? ' has-danger' : '' }}">
    ...
    <input id="regon" type="text" class="form-control form-control-danger" name="regon"
           value="{{ old('regon', $wizardData['regon'] ?? '') }}" placeholder="Regon">
...
<div class="mb-3{{ $errors->has('bank_account') ? ' has-danger' : '' }}">
    ...
    <input id="bank_account" type="text" class="form-control form-control-danger" name="bank_account"
           value="{{ old('bank_account', $wizardData['bank_account'] ?? '') }}" placeholder="Konto bankowe">
